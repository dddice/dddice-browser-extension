        ...
        <>
            <form className="mt-4" onSubmit={onSubmit}>
                <label>
                    <input
                        autoComplete="off"
                        className={classNames("rounded text-gray-100 bg-gray-800 p-2 text-base w-full", isLoading && 'opacity-75')}
                        disabled={isLoading}
                        name="apiKey"
            ...
            <p className="mt-4 text-gray-200 text-xs text-center">
                Enter your <a className="text-neon-blue hover:text-neon-light-blue" href="https://dddice.com/account/developer">dddice API Key</a> above to roll 3D dice using your favorite VTT.
            </p>
        </>
    );
};
